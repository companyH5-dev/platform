...
<div class="tab-container">
  ...
  <div class="n_Main">
    <div class="n_left">
      <ul>
        <li><a style="background: #ffb252;color:#fff;">{{$t("dytii.insidedetails")}}</a></li>
      </ul>
      <!--
      <div class="QQline">
    ...
    <div class="n_right">
      <div class="location">
        {{$t("dytii.homepage")}}<span style=" color:#ffb252;"> >>　{{$t("dytii.insidedetails")}}</span>
      </div>
      <div class="n_centent" style="height:587px;  text-align: center;">
        <img  :src=picName  width="100%" />
      </div>
      <div class="" style=" text-align: center;">
           <el-button type="primary" @click="backNow">{{$t("dytii.back")}}</el-button>
      </div>
...
export default {
  ...
  mounted() {
    if (this.$route.query.picName) {
      this.picName = require('@/assets/big/'+this.$route.query.picName+'.jpg')
    }
    this.baiduMap()
  },
  computed: {},
