...
<div class="tab-container">
  ...
  <div class="n_Main">
  	<div class="n_left">
  		<ul>
  			<li ><a style="background: #ffb252;color:#fff;">{{$t("dytii.factory")}}</a></li>
  		</ul>
  	...
  	<div class="n_right">
  		<div class="location">
        		{{$t("dytii.homepage")}}<span style=" color:#ffb252;"> >>　{{$t("dytii.factory")}}</span>
  		</div>
  		<div class="n_centent" style="height:500px;">
  			　


          <ul class="alMain" v-show="pageNum == 1">

                  <li @click="showDetail('cqzs-1')"><a><img src="@/assets/factory/cqzs-1.jpg" width="216"  /><p>{{$t("dytii.factory")}}</p></a></li>
                  <li @click="showDetail('cqzs-3')"><a><img src="@/assets/factory/cqzs-3.jpg" width="216"  /><p>{{$t("dytii.factory")}}</p></a></li>
                  <li @click="showDetail('cqzs-4')"><a><img src="@/assets/factory/cqzs-4.jpg" width="216"  /><p>{{$t("dytii.factory")}}</p></a></li>
                  <li @click="showDetail('cqzs-6')"><a><img src="@/assets/factory/cqzs-6.jpg" width="216"  /><p>{{$t("dytii.factory")}}</p></a></li>
                  <li @click="showDetail('cqzs-7')"><a><img src="@/assets/factory/cqzs-7.jpg" width="216"  /><p>{{$t("dytii.factory")}}</p></a></li>
                  <li @click="showDetail('cqzs-5')"><a><img src="@/assets/factory/cqzs-5.jpg" width="216"  /><p>{{$t("dytii.factory")}}</p></a></li>

  			</ul>

        <ul class="alMain" v-show="pageNum == 2">

          <li @click="showDetail('cqzs-8')"><a><img src="@/assets/factory/cqzs-8.jpg" width="216"  /><p>{{$t("dytii.factory")}}</p></a></li>
        </ul>
